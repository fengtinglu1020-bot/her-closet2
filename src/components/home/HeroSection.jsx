    ...
    <section className="relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[75vh] items-center">
          ...
          >
            <h1 className="font-display text-[48px] sm:text-[80px] lg:text-[120px] font-black leading-none tracking-tight text-foreground uppercase">
              HER
              <br />
